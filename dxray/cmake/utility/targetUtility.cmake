...
#Setting the default proprties of any target within the project.
function(target_set_default_properties)
...
endfunction(target_set_default_properties)
...
function(project_add_target)
    ...
    if("${TARGET_TYPE}" STREQUAL "SHARED")
        ...
        #When using MSVC the cmake build type cannot be traced with CMAKE_BUILD_TYPE.
    ...
    #Set compile options/target configuration.
    set(C_FLAGS "")
    set(CXX_FLAGS "")

    if(${CMAKE_CXX_COMPILER_ID} STREQUAL Clang)
	    set(CXX_FLAGS -W3 -WX -MP)

	    if(${CMAKE_BUILD_TYPE} STREQUAL Debug)
		    set(CXX_FLAGS ${CXX_FLAGS} -Od -Ob0 -Oi -Z7)
	    else()
            set(CXX_FLAGS ${CXX_FLAGS} -O2 -Ob2 -Ot -Oi -fno-debug-macro)
	    endif()
    elseif(${CMAKE_CXX_COMPILER_ID} STREQUAL MSVC)
	    ...
	    if(${CMAKE_BUILD_TYPE} STREQUAL Debug)
            ...
            set(CXX_FLAGS ${CXX_FLAGS} /O2 /Ob2 /Ot /Oi)
	    endif()
    else()
	    message( FATAL_ERROR "Unidenfitied compiler" )
    endif()

	foreach(C_FLAG ${C_FLAGS})
        target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:C>:${C_FLAG}>)
    endforeach()

    foreach(CXX_FLAG ${CXX_FLAGS})
        target_compile_options(${TARGET_NAME} PRIVATE $<$<COMPILE_LANGUAGE:CXX>:${CXX_FLAG}>)
    endforeach()
